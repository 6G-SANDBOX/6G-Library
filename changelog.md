...
### Changed
- `open5gcore_vm` Update open5gcore to version 10.4.0
- `open5gs_vm` & `open5gcore_vm` The DNS server which is send to the UE's can now be configured using a site variable
