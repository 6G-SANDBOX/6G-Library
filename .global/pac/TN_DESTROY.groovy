...
pipeline {
    ...
    parameters {
        ...
        string(name: 'LIBRARY_BRANCH', defaultValue: 'refs/tags/v0.4.0', description: 'LIBRARY_URL checkout to use. Valid inputs can be refs/heads/<branchName>, refs/tags/<tagName> or <commitId>. Default value can purge TNs from previous 6G-Library version.')
